...
import com.quanfangtongvip.springcloudplayground.context.exception.LackParameterException;
...
public class RequestUtils {
    ...
    public static String getParameterString(HttpServletRequest request, String key) throws Exception {
        ...
        if (StringUtils.isBlank(value)) {
            throw new BaseException(ErrorCode._10008.getErrorCode(), "缺少参数:" + key);
        }
        return value.trim();
    }
